...
![Figure 2 Initial consistent backup created and verified using mysqldump](/assets/images/COM/unit9/part1/Figure%202%20Initial%20consistent%20backup%20created%20and%20verified%20using%20mysqldump.png)

*Figure 2. Initial consistent backup created and verified using mysqldump.*

Verification before restoration was necessary because the successful completion of a command does not alone establish that a usable migration artefact exists. A corrupted, incomplete or empty dump could otherwise transfer the migration failure to the target stage. This emphasis on validation is consistent with Jamshidi, Ahmad and Pahl's (2013) migration model, in which evaluation forms a distinct part of the migration lifecycle rather than an activity that occurs only after final deployment. ([Lancaster University research directory](https://research.lancaster-university.uk/en/publications/cloud-migration-research-a-systematic-review/?utm_source=chatgpt.com))

## Restoration and Initial Validation

An empty retail_db database was created on Azure and the logical backup was restored through the MySQL command-line client over an SSL/TLS connection. Microsoft specifically supports restoring a mysqldump file into a newly created Azure Database for MySQL database through the MySQL client, making the method consistent with the target service's documented migration procedure (Microsoft, 2026). ([Microsoft Learn](https://learn.microsoft.com/th-th/azure/mysql/flexible-server/concepts-migrate-dump-restore?utm_source=chatgpt.com))
...
![Figure 3 Azure MySQL database after the initial restore, showing matching record counts](/assets/images/COM/unit9/part1/Figure%203%20Azure%20MySQL%20database%20after%20the%20initial%20restore%2C%20showing%20matching%20record%20counts.png)

*Figure 3. Azure MySQL database after the initial restore, showing matching record counts.*
...
Scalability represents a further limitation of the chosen approach. The experimental database was small, and the logical export and restoration completed rapidly. However, Microsoft notes that alternative community tools supporting parallel export and import should be considered for very large MySQL databases, while its Azure migration guidance also identifies data-loading and network-transfer performance as relevant concerns (Microsoft, 2026). ([Microsoft Learn](https://learn.microsoft.com/th-th/azure/mysql/flexible-server/concepts-migrate-dump-restore?utm_source=chatgpt.com)) Therefore, the success of mysqldump in this exercise should not be generalised to all database sizes.

These observations reflect wider empirical research. Gholami et al. (2017) found that legacy-to-cloud migration combines technical and non-technical challenges and that inadequate migration preparedness can undermine project outcomes. Similarly, Khajeh-Hosseini, Greenwood and Sommerville (2010) demonstrate through an enterprise case study that the attractiveness of cloud migration must be balanced against risks and organisational consequences. ([ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0306437917301564?utm_source=chatgpt.com))
...
![Figure 4 Final validation of the Azure MySQL database after final synchronisation](/assets/images/COM/unit9/part1/Figure%204%20Final%20validation%20of%20the%20Azure%20MySQL%20database%20after%20final%20synchronisation.png)

*Figure 4. Final validation of the Azure MySQL database after final synchronisation.*
...
Beserra, P.V., Camara, A., Ximenes, R., Albuquerque, A.B. and Mendonça, N.C. (2012) ‘Cloudstep: A step-by-step decision process to support legacy application migration to the cloud’, *2012 IEEE 6th International Workshop on the Maintenance and Evolution of Service-Oriented and Cloud-Based Systems (MESOCA)*, pp. 7–16. doi: 10.1109/MESOCA.2012.6392602. ([ResearchGate](https://www.researchgate.net/publication/259603993_Cloudstep_A_Step-by-Step_Decision_Process_to_Support_Legacy_Application_Migration_to_the_Cloud?utm_source=chatgpt.com))

Gholami, M.F., Daneshgar, F., Low, G. and Beydoun, G. (2016) ‘Cloud migration process: A survey, evaluation framework, and open challenges’, *Journal of Systems and Software*, 120, pp. 31–69. doi: 10.1016/j.jss.2016.06.068. ([DBLP](https://dblp.org/pid/58/6848?utm_source=chatgpt.com))

Gholami, M.F., Daneshgar, F., Beydoun, G. and Rabhi, F. (2017) ‘Challenges in migrating legacy software systems to the cloud—An empirical study’, *Information Systems*, 67, pp. 100–113. doi: 10.1016/j.is.2017.03.008. ([ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0306437917301564?utm_source=chatgpt.com))

Jamshidi, P., Ahmad, A. and Pahl, C. (2013) ‘Cloud migration research: A systematic review’, *IEEE Transactions on Cloud Computing*, 1(2), pp. 142–157. doi: 10.1109/TCC.2013.10. ([Lancaster University research directory](https://research.lancaster-university.uk/en/publications/cloud-migration-research-a-systematic-review/?utm_source=chatgpt.com))

Khajeh-Hosseini, A., Greenwood, D. and Sommerville, I. (2010) ‘Cloud migration: A case study of migrating an enterprise IT system to IaaS’, *2010 IEEE 3rd International Conference on Cloud Computing*, pp. 450–457. doi: 10.1109/CLOUD.2010.37. ([University of St Andrews Research Portal](https://research-portal.st-andrews.ac.uk/en/publications/cloud-migration-a-case-study-of-migrating-an-enterprise-it-system/?utm_source=chatgpt.com))

Khajeh-Hosseini, A., Greenwood, D.S., Smith, J.W. and Sommerville, I. (2012) ‘The Cloud Adoption Toolkit: Supporting cloud adoption decisions in the enterprise’, *Software: Practice and Experience*, 42(4), pp. 447–465. doi: 10.1002/spe.1072. ([University of St Andrews Research Portal](https://research-portal.st-andrews.ac.uk/en/publications/the-cloud-adoption-toolkit-supporting-cloud-adoption-decisions-in/?utm_source=chatgpt.com))

Microsoft (2026) *Migrate your MySQL database to Azure Database for MySQL – Flexible Server using dump and restore*. Microsoft Learn. Available at: [Microsoft Learn migration documentation](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-migrate-dump-restore?utm_source=chatgpt.com) (Accessed: 21 September 2026). ([Microsoft Learn](https://learn.microsoft.com/th-th/azure/mysql/flexible-server/concepts-migrate-dump-restore?utm_source=chatgpt.com))

Oracle (2026) *MySQL 8.0 Reference Manual: **mysqldump** — A Database Backup Program*. Available at: [MySQL 8.0 mysqldump documentation](https://dev.mysql.com/doc/refman/8.0/en/mysqldump.html?utm_source=chatgpt.com) (Accessed: 21 September 2026). ([MySQL](https://dev.mysql.com/doc/refman/8.0/en/mysqldump.html?utm_source=chatgpt.com))

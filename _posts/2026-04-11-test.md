...
<img src="{{ '/assets/images/oop/unit12/Figure 1. Layered architecture of the secure banking system.png' | relative_url }}" alt="Figure 1 - Layered architecture of the secure banking system" width="850">
...
## Supplementary Interactive Artefacts

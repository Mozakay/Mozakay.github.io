...
<img src="{{ '/assets/interactive/secure_banking_architecture_layer2_fixed (1).svg' | relative_url }}" alt="Figure 1 - Layered architecture of the secure banking system" width="850">

...
<img src="/assets/images/oop/unit12/Figure%201.%20Layered%20architecture%20of%20the%20secure%20banking%20system.png" alt="Figure 1 - Layered architecture of the secure banking system" width="850">
...
The project also includes interactive artefacts that explain the security pipeline, transaction lifecycle, and layered architecture in a more visual and dynamic form.

<div style="margin: 20px 0;">
  <h4 style="margin-bottom: 10px;">Interactive Deposit Flow Simulator</h4>
  <iframe
...
<div style="margin: 20px 0;">
  <h4 style="margin-bottom: 10px;">Cybersecurity Layer Overview</h4>
  <iframe
    src="{{ '/assets/interactive/cybersecurity_layer_what_why_bilingual.html' | relative_url }}"
    width="100%"
    height="600"
    style="border:1px solid #d9d9d9; border-radius:12px; background:#ffffff;">
  </iframe>
...
<div style="margin: 20px 0;">
  <h4 style="margin-bottom: 10px;">Advanced OOP Bilingual Overview</h4>
  <iframe
    src="{{ '/assets/interactive/advanced_oop_bilingual_ar_en.html' | relative_url }}"
    width="100%"
    height="600"
    style="border:1px solid #d9d9d9; border-radius:12px; background:#ffffff;">
  </iframe>

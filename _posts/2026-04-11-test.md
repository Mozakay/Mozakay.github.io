...
<img src="{{ '/assets/images/oop/unit12/secure_banking_architecture_layer2_fixed.png' | relative_url }}" alt="Figure 1 - Layered architecture of the secure banking system" width="850">
